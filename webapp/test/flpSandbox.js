		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Creación de flujos de centros",
									"targetURL": "#creacionflujocecos-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"creacionflujocecos-display": {
								"semanticObject": "creacionflujocecos",
								"action": "display",
								"description": "Aplicación para creación de flujos de CECOS, CEBES y CEGES",
								"title": "Creación de flujos de centros",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=creacionflujocecos",
									"url": sap.ui.require.toUrl("creacionflujocecos")
								}
							}
						}
					}
